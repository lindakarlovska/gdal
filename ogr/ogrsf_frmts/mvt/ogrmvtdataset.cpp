                                  ...
                                  CSLConstList papszOptions)
{
    ...
    */
    ...
    if (!MVTGeoUtils::ValidateMinMaxZoom(poLayer->m_nMinZoom,
                                         poLayer->m_nMaxZoom))
    {
        delete poLayer;
        return nullptr;
                                         ...
                                         GDALDataType eDT, char **papszOptions)
{
    ...
    if (!MVTGeoUtils::ValidateMinMaxZoom(poDS->m_nMinZoom, poDS->m_nMaxZoom))
    {
        delete poDS;
        return nullptr;
    }
    ...
    if (pszTilingScheme != nullptr)
    {
        ...
        if (!MVTGeoUtils::InitUserDefinedTilingScheme(
                pszTilingScheme, poDS->m_poSRS, poDS->m_dfTopX, poDS->m_dfTopY,
                poDS->m_dfTileDim0, poDS->m_nTileMatrixWidth0,
                poDS->m_nTileMatrixHeight0))
        {
            delete poDS;
            return nullptr;
        }
